...
export class InvoiceListingComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  public loadData() {
    this.exampleDatabase = new InvoiceService(this.httpClient);
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        ...
        case 'vendor':
          ...
          break;
        case 'invoice_number':
          [propertyA, propertyB] = [a.invoice_number, b.invoice_number];
          break;
        case 'total_amount':
          [propertyA, propertyB] = [a.total_amount, b.total_amount];
          break;
        case 'net_amount':
