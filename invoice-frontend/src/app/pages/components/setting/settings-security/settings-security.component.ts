...
export class SettingsSecurityComponent implements OnInit {
  ...
  constructor(public myapp: AppComponent, public snackbarservice: Snackbarservice, public httpCall: HttpCall, public translate: TranslateService) {
  ...
  ngOnInit(): void {
    let that = this;
    this.httpCall.httpGetCall(httproutes.PORTAL_SETTING_GET).subscribe(function (params) {
      console.log(params)
      if (params.status)
      {
        ...
        that.timer = params.data.settings.Auto_Log_Off.setting_value.toString();
        that.tempTimer = params.data.settings.Auto_Log_Off.setting_value.toString();
        that.otp = params.data.settings.Enable_OTP.setting_value.toString();
        that.tempTimerSwitch = params.data.settings.Auto_Log_Off.setting_status.toString();
        that.tempOtpSwitch = params.data.settings.Enable_OTP.setting_status.toString();
      }
    })
  }
  ...
  updateSetting(objectForEdit: any) {
    ...
    this.httpCall.httpPostCall(httproutes.PORTAL_SETTING_UPDATE, objectForEdit).subscribe(function (params) {
      if (params.status)
      {
