module.exports = {
    ...
    EmailExcelAllProjects: 'All Projects',
    EmailExcelEmployees: 'Employees:',
    EmailExcelAllEmployees: 'All employees',
    EmailExcelStatus: 'Status:',
    EmailExcelAllStatus: 'All Status',
    EmailExcelDateRange: 'Date Range:',
    EmailExcelContacts: 'Contacts:',
    EmailExcelAllContacts: 'All contacts',
    EmailExcelVendors: 'Vendors:',
    EmailExcelAllVendors: 'All vendors',
    EmailExcelCards: 'Cards:',
    EmailExcelAllCards: 'All cards',
    EmailExcelManufacturers: 'Manufacturers:',
    EmailExcelAllManufacturers: 'All manufacturers',
    EmailExcelCostCode: 'Cost code:',
    EmailExcelAllCostCode: 'All cost code',
    EmailExcelItemTypes: 'Item types:',
    EmailExcelAllItemTypes: 'All item types',
    EmailExcelPriceRange: 'Price range:',
    EmailExcelItems: 'Items:',
    EmailExcelAllItems: 'All items',
