module.exports = {
    ...
    InvalidUser: 'Usuario no válido para esta acción.',
    NoDataWithId: 'No se han encontrado datos con esta identificación.',
    ...
    InactiveVendor: 'Your account is inactive, kindly contact your Supplier for activate it.',
    ...
    EmailTemplateRovukTeam: 'Rovuk Supplier & Diversity Team',
    ...
    SponsorNotExist: "Sponsor not exist.",
    ...
    EmailLoginTitle: 'Un nuevo dispositivo ha iniciado sesión con tu cuenta',
    EmailLoginHello: 'Hola',
    EmailLoginLoginFromNewDevice: 'Notamos que ha iniciado sesión desde un nuevo dispositivo:',
    EmailLoginTime: 'Fecha:',
    EmailLoginIP: 'Dirección IP:',
    EmailLoginIfNotYou: 'Si no fuiste tú, por favor siga los siguientes pasos:',
    EmailLoginChangePassword: 'Cambia tu contraseña en la aplicación de ROVUK y en la web.',
    EmailLoginAnyQuestion: 'Si tiene cualquier otra pregunta por favor contáctenos.',
    EmailLoginSeeLocation: 'Click aquí para ver la ubicación',

    Logout: 'Cierre de sesión con éxito.',
    ...
    SupplierChangeOrderDelete: "Change order deleted successfully.",
    ...
    Customer_Report_Created: "Un informe personalizado ha sido creado y esta listo para ser revisado.",
    Attachment_Text: "Este archivo adjunto es solo para fines de visualización, comuníquese con el administrador de la empresa para obtener más información sobre este documento.",
    Report_Sent_Successfully: 'Informe enviado con éxito.',
    ...
    //Users Report
    EmailTeamReportTitle: '¡Aquí está el informe de su equipo!',
    EmailTeamReportText1: 'Hemos creado un archivo de Excel que contiene el informe del equipo basado en la siguiente selección:',
    EmailTeamReportText2: 'Para modificar estas preferencias, vaya a la pestaña de configuración ubicada en su portal de usuario.',

    Data_Correct: "Datos correctos",

    // Supplier Project Pay Retainage
    PaymentRetainageAdd: "Project pay retainage added successfully.",
    PaymentRetainageUpdate: "Project pay retainage updated successfully.",
    PaymentRetainageUpdateStatus: "Project pay retainage status updated successfully.",
    ...
    // Excel Report Common
    EmailExcelProjects: 'Proyectos:',
    EmailExcelAllProjects: 'Todos los Proyectos',
    EmailExcelEmployees: 'Todos los Empleados:',
    EmailExcelAllEmployees: 'Todos los Empleados',
    EmailExcelStatus: 'Estado:',
    EmailExcelAllStatus: 'Todos los Estados',
    EmailExcelDateRange: 'Fechas seleccionadas:',
    EmailExcelContacts: 'Contactos:',
    EmailExcelAllContacts: 'Todos los Contactos',
    EmailExcelVendors: 'Proveedores:',
    EmailExcelAllVendors: 'Todos los Proveedores',
    EmailExcelCards: 'Tarjetas:',
    EmailExcelAllCards: 'Todas las Tarjetas',
    EmailExcelManufacturers: 'Fabricantes:',
    EmailExcelAllManufacturers: 'Todos los Fabricantes',
    EmailExcelCostCode: 'Códigos de Costo:',
    EmailExcelAllCostCode: 'Todos los Códigos de Costo',
    EmailExcelItemTypes: 'Tipos de Artículos:',
    EmailExcelAllItemTypes: 'Todos los Tipos de Artículos',
    EmailExcelPriceRange: 'Rango de precios:',
    EmailExcelItems: 'Artículos:',
    EmailExcelAllItems: 'Todos los Artículos',
    EmailExcelRoles: 'Roles:',
    EmailExcelAllRoles: 'All roles',

    //Employee
    Employee_First_Name: "Primer Nombre",
    Employee_Middle_Name: "Segundo Nombre",
    Employee_Last_Name: "Apellido",
    Employee_Email: "Correo Electrónico",
    Employee_SSN: "Número de Seguro Social",
    Employee_Employee_Number: "Número de Empleado",
    Employee_User_Role: "Rol del Usuario",
    Employee_Login_From: "Iniciar Sesión Desde",
    Employee_Gender: "Género",
    Employee_Date_Of_Birth: "Fecha de Nacimiento",
    Employee_Status: "Estado",
    Employee_Phone: "Teléfono",
    Employee_Secondary_Email: "Correo Electrónico Secundario",
    Employee_Street_1: "Calle 1",
    Employee_Street_2: "Calle 2",
    Employee_City: "Ciudad",
    Employee_State: "Estado",
    Employee_Zipcode: "Código Postal",
    Employee_Country: "País",
    Employee_Cost_Code: "Código de Costo",
    Employee_Salary_Hourly_Rate: "Salario del Empleado (Tarifa por Hora)",
    Employee_Start_Date: "Fecha de Inicio",
    Employee_Manager: "Gerente",
    Employee_Supervisor: "Supervisor",
    Employee_Location: "Ubicación",
    Employee_Department: "Departamento",
    Employee_Job_Title: "Título del Trabajo",
    Employee_Job_Type: "Tipo de Trabajo",
    Employee_Payroll_Cycle: "Ciclo de Nómina",
    Employee_Payroll_Group: "Grupo de Nómina",
    Employee_Card_Type: "Tipo de Tarjeta de Crédito",
    Employee_Language_Spoken: "Lenguaje hablado",
    EmployeeTitle: "Equipo",
    ...
    // Role
    RoleListing: 'Listado de roles',
    RoleAdded: 'Rol añadido exitosamente.',
    ...
    //User shortcuts
    UsershortcutsListing: "Listado de Accesos Directos",
    UsershortcutsUpdated: "Accesos directos actualizados correctamente",
    UsershortcutsAdded: "Accesos directos agregados correctamente",
    UsershortcutsDeleted: "Accesos directos eliminados correctamente",

    // Payroll Group
    PayrollGroupListing: 'Listado de grupos de nómina',
    PayrollGroupAdded: 'Grupo de nómina añadido exitosamente.',
    ...
    JobTypeAdded: 'Tipo de puesto añadido exitosamente.',
    ...
    JobTitleAdded: 'Título de trabajo añadido exitosamente.',
    ...
    // Location
    LocationAdded: 'Ubicación añadida exitosamente.',
    LocationUpdated: 'Ubicación actualizada exitosamente.',
    LocationDeleted: 'Ubicación eliminada exitosamente.',

    Location_Alert_TITLE: 'La ubicación que se encuentra asignada a ti ha sido cambiada',
    Location_Alert_Assigned_To_You: 'La ubicación en la que se le asignó trabajar,',
    Location_Alert_has_been_change: 'ahora se ha cambiado a ',
    Location_Alert_line1_last: 'Detalles a continuación:',
    Location_Alert_Update_Info_Text: 'Información de contacto del supervisor de la nueva ubicación:',
    Location_contact_name: "Nombre:",
    Location_contact_number: "Número de Teléfono: ",
    Location_Mail_Subject: "Se ha cambiado una ubicación",
    ...
    // Document Expiration
    EmailSingleDocExpireTitle: '¡Actúa pronto!',
    EmailSingleDocExpireYourDocument: 'Su documento',
    EmailSingleDocExpireExpireInNext: 'Va a expirar en',
    EmailSingleDocExpireUpdateDocument: 'día(s). Por favor, actualícelo antes de este tiempo.',
    EmailAdminDocExpireWillExpireInNext: 'Algunos documentos de los empleados vencerán en los próximos',
    EmailAdminDocExpireWillExpireInNext_Your: 'Algunos de sus documentos vencerán en el próximo',
    EmailAdminDocExpireMoreInfo: 'día. Verifique el archivo adjunto con dicha información.',
    EmailAdminDocExpireDocumentNeedToUpdate: 'Documentos que necesitan actualizarse.',

    //Emergency Contact Email Template
    Emergency_Contact_Email_Subject: 'Contacta al administrador: Se necesita su información de emergencia',
    Message_About_ContactInfo: "Mensaje importante acerca de su información de contacto",
    Emergency_Contact_Info_Update: "Su información de contacto de emergencia necesita ser actualizada o revisada.",
    Provide_Recent_Information: "Por favor proporcione la información más reciente en la aplicación móvil o comuníquese con el administrador de la empresa para hacerlo.",
    Company_Maintains_Information: "Es importante que la empresa mantenga este tipo de información actualizada.",
    Following_Data_Text: "Tenga en cuenta que es posible que necesitemos los siguientes datos; nombre, relación, número de teléfono, dirección de correo electrónico y dirección física.",
    ...
    CompanySettingAlreadyUpdated: 'La configuración de la compañía ya está actualizada.',
    ...
    EmailDocumentExpireTitle: 'Los documentos necesitan actualizarse',
