...
var processInvoiceController = require('./../process_invoice/processInvoiceController');
                                                ...
                                                if (extension.toLocaleLowerCase() == 'pdf') {
                                                    ...
                                                    bucketOpration.uploadFile(PARAMS, async function (err, resultUpload) {
                                                        if (err) {
                                                            ...
                                                            processInvoiceController.mailBoxSaveInvoiceProcess(connection_db_api, [fileUrl], email);
                                                        }
                                                    });
                                                }
                                            }
